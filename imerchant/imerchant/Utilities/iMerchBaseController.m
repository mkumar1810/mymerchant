...
@interface iMerchBaseController ()

@end

@implementation iMerchBaseController
...
- (void) setupNavigationBarItems
{
    ...
    [self.navBar setBarTintColor:[UIColor colorWithRed:0.0 green:0.0 blue:(165.0/255.0) alpha:1.0]];
    ...
    UIButton * l_exitrptbtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0,20.0, 20.0)];
    [l_exitrptbtn setImage:[UIImage imageNamed:@"cancel"] forState:UIControlStateNormal];
    [l_exitrptbtn addTarget:self action:@selector(exitReportPreview) forControlEvents:UIControlEventTouchUpInside];
    [l_exitrptbtn setBackgroundColor:[UIColor clearColor]];
    self.bar_exitreport_btn = [[UIBarButtonItem alloc] initWithCustomView:l_exitrptbtn];
