...
UILabel * (^__c_getStandardLabel)(NSString*) = ^(NSString * p_textVal)
{
    ...
    l_retlbl.textColor = [iMerchDefaults getDefaultTextColor];
...
UITextField * (^__c_getStandardTextField)() = ^()
{
    ...
    l_stdText.textColor = [iMerchDefaults getDefaultTextColor];
...
UIButton * (^__c_getStandardButton)() = ^()
{
    ...
    [l_stdbutton setTitleColor:[iMerchDefaults getDefaultTextColor] forState:UIControlStateNormal];
    return l_stdbutton;
};
