...
#import "iMerchNavController.h"
#import "iMerchBaseController.h"

@interface iMerchNavController()
{
...
@implementation iMerchNavController
...
/*- (instancetype)initWithRootViewController:(UIViewController *)rootViewController
                              withLogOutCB:(NOPARAMCALLBACK) p_logoutCB
{
    self = [super initWithRootViewController:rootViewController];
    if (self)
    {
        _logoutCB = p_logoutCB;
    }
    return self;
}
*/
...
{
    return [[iMerchNavControllerTransitionAnimator alloc] initWithNavOperation:operation];
}

@end

@interface iMerchNavControllerTransitionAnimator()
{
...
@implementation iMerchNavControllerTransitionAnimator
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    id<iMerchCustNaviDelegates>  l_toViewController = (id<iMerchCustNaviDelegates>) [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    ...
    id<iMerchCustNaviDelegates> l_fromViewController = (id<iMerchCustNaviDelegates>) [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
